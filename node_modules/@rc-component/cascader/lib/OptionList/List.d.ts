...
declare const RawOptionList: React.ForwardRefExoticComponent<Pick<import("@rc-component/select/lib/hooks/useBaseProps").BaseSelectContextProps, "disabled" | "prefixCls" | "searchValue" | "direction" | "notFoundContent" | "open" | "multiple" | "toggleOpen"> & {
